...
import com.elearningportal.apps.config.audit.AuditEventConverter;
import com.elearningportal.apps.domain.PersistentAuditEvent;
...
import static com.elearningportal.apps.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
