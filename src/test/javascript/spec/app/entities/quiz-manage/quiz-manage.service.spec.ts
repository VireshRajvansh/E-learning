...
describe('Service Tests', () => {
    ...
    describe('QuizManage Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(QuizManageService);
        ...
        describe('Service methods', () => {
            ...
            it('should return QuizManage', () => {

                let entity: QuizManage;
                service.find(123).subscribe((_entity: QuizManage) => {
                    entity = _entity;
                });
