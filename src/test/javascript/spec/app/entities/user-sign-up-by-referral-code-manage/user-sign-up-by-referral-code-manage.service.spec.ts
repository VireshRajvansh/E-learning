...
describe('Service Tests', () => {
    ...
    describe('UserSignUpByReferralCodeManage Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(UserSignUpByReferralCodeManageService);
        ...
        describe('Service methods', () => {
            ...
            it('should return UserSignUpByReferralCodeManage', () => {

                let entity: UserSignUpByReferralCodeManage;
                service.find(123).subscribe((_entity: UserSignUpByReferralCodeManage) => {
                    entity = _entity;
                });
