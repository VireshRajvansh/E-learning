...
describe('Service Tests', () => {
    ...
    describe('StripePaymentManage Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(StripePaymentManageService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/stripe-payments';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return StripePaymentManage', () => {

                let entity: StripePaymentManage;
                service.find(123).subscribe((_entity: StripePaymentManage) => {
                    entity = _entity;
                });
