...
describe('Service Tests', () => {
    ...
    describe('CourseManage Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CourseManageService);
        ...
        describe('Service methods', () => {
            ...
            it('should return CourseManage', () => {

                let entity: CourseManage;
                service.find(123).subscribe((_entity: CourseManage) => {
                    entity = _entity;
                });
