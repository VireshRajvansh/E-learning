...
describe('Service Tests', () => {
    ...
    describe('PlayListManage Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(PlayListManageService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/play-lists';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PlayListManage', () => {

                let entity: PlayListManage;
                service.find(123).subscribe((_entity: PlayListManage) => {
                    entity = _entity;
                });
