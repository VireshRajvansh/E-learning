...
describe('Service Tests', () => {
    ...
    describe('StripeCustomerManage Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(StripeCustomerManageService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/stripe-customers';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return StripeCustomerManage', () => {

                let entity: StripeCustomerManage;
                service.find(123).subscribe((_entity: StripeCustomerManage) => {
                    entity = _entity;
                });
