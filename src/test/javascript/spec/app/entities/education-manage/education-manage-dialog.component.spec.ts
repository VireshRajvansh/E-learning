...
import { EducationManageDialogComponent } from '../../../../../../main/webapp/app/entities/education-manage/education-manage-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('EducationManage Management Dialog Component', () => {
        let comp: EducationManageDialogComponent;
        let fixture: ComponentFixture<EducationManageDialogComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [EducationManageDialogComponent],
                providers: [
                    EducationManageService
                ]
            })
            .overrideTemplate(EducationManageDialogComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(EducationManageDialogComponent);
