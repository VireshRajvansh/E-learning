...
describe('Service Tests', () => {
    ...
    describe('EducationManage Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EducationManageService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/educations';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return EducationManage', () => {

                let entity: EducationManage;
                service.find(123).subscribe((_entity: EducationManage) => {
                    entity = _entity;
                });
