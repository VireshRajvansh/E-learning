...
describe('Service Tests', () => {
    ...
    describe('AddressManage Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(AddressManageService);
        ...
        describe('Service methods', () => {
            ...
            it('should return AddressManage', () => {

                let entity: AddressManage;
                service.find(123).subscribe((_entity: AddressManage) => {
                    entity = _entity;
                });
