...
describe('Service Tests', () => {
    ...
    describe('StudentManage Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(StudentManageService);
        ...
        describe('Service methods', () => {
            ...
            it('should return StudentManage', () => {

                let entity: StudentManage;
                service.find(123).subscribe((_entity: StudentManage) => {
                    entity = _entity;
                });
