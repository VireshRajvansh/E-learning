...
describe('Service Tests', () => {
    ...
    describe('EducationCollegeManage Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EducationCollegeManageService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/education-colleges';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return EducationCollegeManage', () => {

                let entity: EducationCollegeManage;
                service.find(123).subscribe((_entity: EducationCollegeManage) => {
                    entity = _entity;
                });
