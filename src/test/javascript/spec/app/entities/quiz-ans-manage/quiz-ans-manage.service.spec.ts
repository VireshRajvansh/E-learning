...
describe('Service Tests', () => {
    ...
    describe('QuizAnsManage Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(QuizAnsManageService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/quiz-ans';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return QuizAnsManage', () => {

                let entity: QuizAnsManage;
                service.find(123).subscribe((_entity: QuizAnsManage) => {
                    entity = _entity;
                });
