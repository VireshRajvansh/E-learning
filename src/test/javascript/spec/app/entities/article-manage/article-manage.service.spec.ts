...
describe('Service Tests', () => {
    ...
    describe('ArticleManage Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ArticleManageService);
        ...
        describe('Service methods', () => {
            ...
            it('should return ArticleManage', () => {

                let entity: ArticleManage;
                service.find(123).subscribe((_entity: ArticleManage) => {
                    entity = _entity;
                });
