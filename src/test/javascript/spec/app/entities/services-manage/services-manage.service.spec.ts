...
describe('Service Tests', () => {
    ...
    describe('ServicesManage Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ServicesManageService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/services';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ServicesManage', () => {

                let entity: ServicesManage;
                service.find(123).subscribe((_entity: ServicesManage) => {
                    entity = _entity;
                });
