...
describe('Service Tests', () => {
    ...
    describe('StripeTransactionManage Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(StripeTransactionManageService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/stripe-transactions';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return StripeTransactionManage', () => {

                let entity: StripeTransactionManage;
                service.find(123).subscribe((_entity: StripeTransactionManage) => {
                    entity = _entity;
                });
