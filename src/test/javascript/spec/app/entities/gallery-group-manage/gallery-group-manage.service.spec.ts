...
describe('Service Tests', () => {
    ...
    describe('GalleryGroupManage Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(GalleryGroupManageService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/gallery-groups';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return GalleryGroupManage', () => {

                let entity: GalleryGroupManage;
                service.find(123).subscribe((_entity: GalleryGroupManage) => {
                    entity = _entity;
                });
