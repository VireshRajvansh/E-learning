...
@Injectable()
export class ArticleManagePopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.articleModalRef(component, new ArticleManage());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    articleModalRef(component: Component, article: ArticleManage): NgbModalRef {
