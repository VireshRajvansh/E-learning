...
currentAccount: any;
    userSignUpByReferralCodes: UserSignUpByReferralCodeManage[];
    error: any;
    success: any;
    ...
    loadAll() {
        if (this.currentSearch) {
            this.userSignUpByReferralCodeService.search({
                page: this.page - 1,
        ...
        this.userSignUpByReferralCodeService.query({
            page: this.page - 1,
            size: this.itemsPerPage,
            sort: this.sort()}).subscribe(
            (res: ResponseWrapper) => this.onSuccess(res.json, res.headers),
    ...
    transition() {
        this.router.navigate(['/user-sign-up-by-referral-code-manage'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: UserSignUpByReferralCodeManage) {
        return item.id;
    }
