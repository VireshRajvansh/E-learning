...
@Component({
    selector: 'jhi-quiz-manage',
    templateUrl: './quiz-manage.component.html'
})
export class QuizManageComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/quiz-manage'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: QuizManage) {
        return item.id;
    }
