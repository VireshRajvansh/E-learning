...
@Component({
    selector: 'jhi-gallery-manage',
    templateUrl: './gallery-manage.component.html'
})
export class GalleryManageComponent implements OnInit, OnDestroy {

currentAccount: any;
    galleries: GalleryManage[];
    error: any;
    success: any;
    ...
    transition() {
        this.router.navigate(['/gallery-manage'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    clear() {
        this.page = 0;
        this.currentSearch = '';
        this.router.navigate(['/gallery-manage', {
            page: this.page,
            sort: this.predicate + ',' + (this.reverse ? 'asc' : 'desc')
        }]);
        this.loadAll();
    ...
    trackId(index: number, item: GalleryManage) {
        return item.id;
    }
