...
@Component({
    selector: 'jhi-play-list-manage',
    templateUrl: './play-list-manage.component.html'
})
...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/play-list-manage'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    clear() {
        this.page = 0;
        this.currentSearch = '';
        this.router.navigate(['/play-list-manage', {
            page: this.page,
            sort: this.predicate + ',' + (this.reverse ? 'asc' : 'desc')
        }]);
        this.loadAll();
    ...
    trackId(index: number, item: PlayListManage) {
        return item.id;
    }
